      ...
      {/* <div className="promo-bar" id="topbar">
        <div className="container">
          <div id="slideText">
            ...
            <p>
              <a href="">
                Hotline mua hàng: <b>0834505170 </b>{" "}
              </a>
            </p>
          </div>
        </div>
      ...
      <header className="main-header">
        <div className="wrapper-header header-transparent " id="themes-header" style={{marginLeft: "-85px"}}>
          <div className="container" >
            ...
            <div className="header-middle row-flex flex-flow-header" style={{width: "1225px"}}>
                ...
                >
                  <a href="/">
                    <h1 className="logo">
                      <img
                        itemProp="logo"
                        src="/assets/images/logoShop.png"
                        style={{ width: "200px" }}
              ...
              <div className="col-md-8 wrap-header-4 hidden-sm hidden-xs">
              ...
              <div className="col-md-2 wrap-header-3 col-sm-6 col-xs-5" style={{paddingBottom: "15px"}}>
